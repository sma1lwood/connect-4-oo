...
class Game {
  ...
  function endGame(msg) {
    ...
    top.removeEventListner('click', this.handleGameClick);
  }
...
document.getElementById('begin-Game').addEventListener('click', () => {
  let p1 = new Player(document.getElementById('p-1').value);
  let p2 = new Player(document.getElementById('p-2').value);
  new Game(p1, p2);
});
...
// }
// // vs computer instead of player
// function vsComp(sumPlayer) {
// 	if (sumPlayer === computer) {
// 		p2 = computer;
// 	} else {
// 		p2 = currPlayer;
//   }
